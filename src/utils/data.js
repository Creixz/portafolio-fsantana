export const SKILLS = [
    {
        title: "Frontend",
        icon: "./breadcrumb_12098282.png",
        skills: [
            { skill: "HTML5", percentage: "70%" },
            { skill: "CSS3", percentage: "65%" },
    ...
    {
        title: "Backend",
        icon: "./landing-page_12098210.png",
        skills: [
            { skill: "SpringBoot", percentage: "75%" },
            { skill: "SpringSecurity", percentage: "65%" },
            { skill: "Node.js", percentage: "40%" },
        ],
    },
    {
        title: "Tools",
        icon: "./wrench_10825492.png",
        skills: [
    ...
    {
        title: "Soft Skills",
        icon: "./administration_11969648.png",
        skills: [
